...
const ReportData = {
    ...
    diplomacy: {
        events: [
            { date: '2024.11.15', event: '首脑会谈（秘鲁APEC）', index: 50, change: '基准' },
            { date: '2024.12.25', event: '岩屋毅访华', index: 55, change: '+5（关键转机）' },
            { date: '2025.11.7', event: '高市"台湾有事"言论', index: 25, change: '-30' },
            { date: '2025.11.18', event: '磋商失败', index: 20, change: '-5（历史低点）' }
        ],
        chartData: {
            dates: ['2024.11.15', '2024.12.25', '2025.11.7', '2025.11.18'],
            values: [50, 55, 25, 20],
            labels: ['首脑会谈', '岩屋访华', '高市言论', '磋商失败']
        }
    },
